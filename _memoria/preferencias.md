...
> Como o Claude escreve em nome do Nutri Chedid. Tom, estilo, vícios a evitar.

## Tom de voz

**Autêntico, confiante e orientado a resultado.** A marca tem prova social real (milhares de pessoas, 20+ países, case B2B gravado) — a comunicação transmite **autoridade sem arrogância** e fala com verdade, não com promessa vazia. Conteúdo de alta performance, mas humano e próximo.

O Henrique, pessoalmente, comunica de forma **direta, enérgica e descontraída**. A voz da marca pode ser mais polida que a fala dele, mas mantém essa **autenticidade e proximidade** — nada de corporativês.

## ⚠️ Premissa de copy por público (MUITO IMPORTANTE)

A abordagem muda conforme o público:

- **B2B — atrair empresários / vender o Projeto Mais Saúde:**
  **NÃO usar spin-selling nem copy genérica de venda.** Chegar "na moralzinha": perguntar o que a pessoa quer, **contar a história do Henrique e do projeto**, com mais **storytelling e emoção**. Relação primeiro, venda depois. O decisor entra por **cultura** (CEO que cuida da própria saúde), não por esquema de vendas.

- **B2C — consultoria online (Team Chedid):**
...
## Padrão obrigatório de blog posts

Todo blog post produzido deve incluir, sempre:
- **Espaço para a assinatura do Henrique** com o CRN visível
- **Bio do autor** com as credenciais do Henrique
- **Fontes citadas** do conteúdo (estudos, sociedades de nutrição)

> Motivo: nutrição é YMYL (saúde). Google e IAs priorizam conteúdo com autor credenciado e fontes verificáveis (E-E-A-T) — aumenta as chances de ranquear em SEO e de ser citado nos motores de IA (GEO).
