...
(async () => {
  try {
    const htmlPath = path.resolve(__dirname, 'apresentacao-slides-nutri-chedid-interativa.html');
    const pdfPath = path.resolve(__dirname, 'apresentacao-nutri-chedid-interativa.pdf');
    ...
    // Estilo de impressão: mostra todos os slides, um por página 16:9,
    // e esconde os controles de navegação (setas, dots, barra de progresso).
